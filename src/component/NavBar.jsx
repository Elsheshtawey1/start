...
function NavBar() {
  ...
  return (
    <header className="header bg-[var(--main-color)] h-19 mx-auto pt-2 px-25 flex justify-between items-center max-[700px]:items-center max-[700px]:text-center max-[700px]:px-4  ">
      ...
      <nav
        className={`max-[700px]:bg-[var(--main-color)] max[700px]:shadow-sm  absolute top-16 left-0 w-full md:static md:w-auto md:flex md:items-center md:gap-8 px-6 py-4 md:p-0 transition-all duration-300 ${
          isOpen ? "block" : "hidden"
        }`}
      >
