...
function HeroSec() {
  return (
    <main className="heroSec mx-auto pt-20 px-25 flex justify-between items-center max-[785px]:flex-wrap max-[700px]:flex-col-reverse max-[700px]:justify-center max-[700px]:items-center max-[700px]:text-center max-[700px]:px-4 max-[800px]:justify-center max-[800px]:items-center max-[800px]:text-center">
