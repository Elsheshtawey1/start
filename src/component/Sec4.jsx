...
function Sec4() {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto gap-5 mt-25 pt-3.5 lg:w-5/7 px-25 max-[700px]:px-6 w-full max-w-5x2 h-auto flex justify-between items-center max-[785px]:flex-wrap max-[785px]:justify-center max-[785px]:flex-col-reverse max-[700px]:w-full text-center"
    >
      <motion.div
